...
class AdministrativoController extends Controller
{
    ...
    public function index()
    {
        ...
        //pero nos trae toda la informacion con el metodo all()
    ...
    {
        //declaramos una variable datos de todo el request del formulario
        //$datos= request()->all();
        ...
        ->with('mesaje','Personal administrativo registrado correctamente')
        ->with('icono','success');
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect()->route('admin.administrativos.index')
        ->with('mesaje','Se actualizo los datos correctamente')
        ->with('icono','success');
    }
    ...
    public function destroy( $id)
    {
        ...
        return redirect()->route('admin.administrativos.index')
        ->with('mesaje','Se elimino el personal administrativo correctamente')
        ->with('icono','success');
    }
